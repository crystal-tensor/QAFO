...
plt.xlabel("US Composite Score"); plt.ylabel("CN Composite Score"); plt.title("帕累托前沿（美国与中国综合分数）")
...
plt.xlabel("US Composite Score"); plt.ylabel("CN Composite Score"); plt.title("谈判菜单 on Frontier")
...
plt.xticks(rotation=45); plt.ylabel("Q-NFI"); plt.title("量子谈判前沿指数” (Weekly)")
...
html = (
    ...
    "<h2>谈判菜单</h2><p>Three representative frontier packages</p>"
    "<img src='menus_on_frontier.png' alt='Menus on Frontier'>"
    f"{menus_table_html}"
    "<h2>Q-NFI (量子谈判前沿指数”)</h2>"
